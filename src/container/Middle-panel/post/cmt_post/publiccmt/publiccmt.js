...
export default function CmtA(InfoCmt) {
    ...
    const CmtImg1 =() =>(
        ...
        <div class="public-cmt">
                        <div class="cmt-img-top">
                            <div class="avt-in-public-cmt">
                                <img src={InfoCmt.src_avt_in_cmt_1} alt=""/>
                            </div>
                            <div class="cmt-ct">
                                <div class="cmt-img-ct-top-1">
                                    <div class="name"><a href="#"><b>{InfoCmt.name_cmt_er_1}</b></a></div>
                                    <div class="cmt-text"><p>{InfoCmt.cmt_ct_w_1}</p></div>
                                </div>
                                <div class="cmt-img-ct-img-1">
                                    <img src={InfoCmt.cmt_ct_img_1} alt=""/>
                                </div>
                                <div class="cmt-ct-bot">
                                    <ul>
                                        <li><p class="time">{InfoCmt.time_cmt_1}</p></li>
                                        <li><p><b>Like</b></p></li>
                                        <li><p><b>Reply</b></p></li>
                                        <li><p><b>Share</b></p></li>
                                    </ul>
        ...
        <div class="public-cmt">
                        <div class="cmt-img-top">
                            ...
                            <div class="cmt-ct">
                                <div class="cmt-img-ct-top-2">
                                    <div class="name"><a><b>{InfoCmt.name_cmt_er_2}</b></a></div>
                                    <div class="cmt-text"><p>{InfoCmt.cmt_ct_w_2}</p></div>
                                </div>
                                <div class="cmt-img-ct-img-2">
                                    <img src={InfoCmt.cmt_ct_img_2} alt=""/>
                                </div>
                                <div class="cmt-ct-bot">
                                    <ul>
                                        <li><p class="time">{InfoCmt.time_cmt_2}</p></li>
                                        <li><p><b>Like</b></p></li>
                                        <li><p><b>Reply</b></p></li>
                                        <li><p><b>Share</b></p></li>
                                    </ul>
    ...
    const CmtW =()=>(
        <div class="public-cmt">
            <div class="cmt-top">
                ...
                <div class="cmt-ct">
                    <div class={InfoCmt.class_cmt_ct}>
                        <div class="bordercmt"> 
                            <div class="name"><a><b>{InfoCmt.name_cmt_er}</b></a></div>
                            <div class="cmt-text"><p>{InfoCmt.cmt_ct_w_1}</p></div>
                        </div>
                    ...
                    <div class="cmt-ct-bot">
                        <ul>
                            <li><p class="time">{InfoCmt.time_cmt}</p></li>
                            <li><p><b>Like</b></p></li>
                            <li><p><b>Reply</b></p></li>
                            <li><p><b>Share</b></p></li>
                        </ul>
